...
import { videoNodeSize } from '../../utils/constants'
...
export default function VideoNode({ selected, data }: VideoNodeProps) {
    const { videoDataUrl, fileName } = data
    ...
    return (
        ...
        >
            <div
                ...
                `}
                style={{ width: videoNodeSize.width, height: videoNodeSize.height }}
            >
                <Handle
                    type="target"
                ...
                <video
                    ...
                    style={{ height: videoNodeSize.height - 36 }}
                    draggable={false}
                />
            </div>
        </div>
